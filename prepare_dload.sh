#!/bin/sh
##############################################################################
# Script to execute scripts post data loader install                         #
##############################################################################
# Parameters :-                                                              #
...
# sh prepare_dload.sh name_of_log.txt hou_password fscpw syspw               #
##############################################################################
...
run_script     ${LOGFILE_HOME}/scripts   pel_triggers.sql
run_script     ${LOGFILE_HOME}/scripts   aue_triggers.sql
run_script     ${LOGFILE_HOME}/scripts   disable_pel_triggers.sql
run_script     ${LOGFILE_HOME}/scripts   disable_aue_triggers.sql
run_script     ${LOGFILE_HOME}/scripts   disable_triggers.sql
run_script     ${LOGFILE_HOME}/scripts   cleanup_dl_tables.sql
run_script_dba ${LOGFILE_HOME}/scripts   gather_stats_dbms.sql
