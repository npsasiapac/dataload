--
-- dl_had_acan_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Housing Advice Case Associations Dataload Table has
...
-- ----          ---  ------ ----  ------------
-- 14-NOV-2017   6.0  6.14   MJK   Initial Creation
--
--
-------------------------------------------------------------------------------
--
...
--
-- 
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_ACAS_ALTERNATE_REF','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_APP_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_TCY_ALT_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_HRV_ACAR_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAD_ADV_CASE_ASSOCIATIONS','LACAN_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
--
