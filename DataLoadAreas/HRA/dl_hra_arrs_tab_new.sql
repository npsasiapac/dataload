...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Dataload Tables have
...
--
-- 09-JUN-2009   3.0  5.15.1 MB    Reused structure for MH bespoke loads, 
--                                 renamed mh_tab_new.sql from dl_hem_tab_new.sql
--
-- 11-NOV-2013   4.0  6.9.0        Changed to create Arrears Arrangements with both
--                                 Insert new (MB) and Posted Dates (PD) versions
--                                 commented out line 147 and added date check at line
--                                 367 (368 - 376) both changes are in line with current version  
--
-- 21-MAR-2016   5.0  6.13.0 JS    allowed for nullable being the same as current setting
...
BEGIN
--
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_PAY_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_ARA_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_INTERVAL_PERIOD','NUMBER','2','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_INTERVAL_UNITS','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_DEFAULT_AMOUNT','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_BALANCE','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_END_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_ACTUAL_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_HRV_HRE_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_END_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_FIRST_DD_TAKEN_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_PMY_CODE','VARCHAR2','2','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_ARRANGEMENTS','LARR_NOP_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
--
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_PAY_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_ARA_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_SEQNO','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_AMOUNT','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_AMEND_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_EXT_PROCESSED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_ARREARS_INSTALMENTS','LAIN_COMMENTS','VARCHAR2','240','Y',l_t,l_s,l_f);
--
