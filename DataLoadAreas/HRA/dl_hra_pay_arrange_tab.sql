...
-- ----          ---  ------ ----  ------------
-- 12-JUN-2009   1.0  5.16.0 IR    Initial Creation.
-- 
-- 03-MAY-2016   2.0  6.12.0 VRS   6.12 Table Changes
-- 21-JUN-2016   3.4  6.13   AJ    allowed for nullable being the same as current setting
...
--
-- 04-DEC-2018   3.5  6.18.0 VRS   6.18 Table Changes to accommodate RDS_ACCOUNT_DEDUCTIONS Change
--                                 for Queensland. In order to link the payment_expectation record to the
--                                 right RDS_ACCOUNT_DEDUCTION record we need to have the additional following 
--                                 columns provided;
--
--                                 LPEXP_LINK_TO_RACD
--
--                                 RACD_RAUD_REFNO
--                                 RACD_RAC_ACCNO       (Not needed use LPEXP_RAC_PAY_REF)
--                                 RACD_RADT_CODE
--                                 RACD_START_DATE
--                                 RACD_HRV_RBEG_CODE
...
--
--
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_RAC_PAY_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_HRV_PEXT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DUE_DATE_OF_FIRST_PAY','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_AMOUNT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_TRS_TRT_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_TRS_CODE','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_TRT_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PRIORITY','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_ALLOCATE_TO_FUTURE_PAY','VARCHAR2','1','Y',l_t,l_s,l_f);
--PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PAYMENT_DAYS_TOLERANCE','NUMBER','2','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_FREQUENCY','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_ACHO_ALT_REFERENCE','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_AUTHORISED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_AUTHORISED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_EVENT_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_REQUESTED_PERCENTAGE','NUMBER','7,4','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PAR_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PAR_REFERENCE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_FIXED_AMOUNT_COMPONENT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PERCENTAGE_COMPONENT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DEN_ACCOUNT_CHARGE','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_MAX_EXPA_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
--PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_MONITORING_SUSPENDED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_EXTERNAL_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BDE_BTY_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BDE_BANK_NAME','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BAD_ACCOUNT_NO','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BAD_ACCOUNT_NAME','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BAD_SORT_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BDE_BRANCH_NAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BAD_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_AUN_BAD_ACCOUNT_NO','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_PAR_ORG_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_BAD_PAR_REFERENCE','VARCHAR2','20','Y',l_t,l_s,l_f);
--PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_DDI_CREATE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
-- New columns for RDS_ACCOUNT_DEDUCTIONS
--
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_LINK_TO_RACD','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_RACD_RAUD_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_RACD_RADT_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_RACD_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_RACD_HRV_RBEG_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
--
PR('DL_HRA_PAYMENT_EXPECTATIONS','LPEXP_REFNO','NUMBER','10','N',l_t,l_s,l_f);
--
--
-- EXPECTED_PAYMENTS
--
--
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_TYPE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_RAC_PAY_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_COMMENT','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PAYMENT_AMOUNT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PAYMENT_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PAYMENT_OVERDUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_UNPAID_BALANCE','NUMBER','11,2','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PIT_PPR_AYE_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PIT_PPR_AYE_YEAR','NUMBER','4','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PIT_PPR_HRV_PPC_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PIT_PAYMENT_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_AIN_ARR_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_AIN_SEQNO','NUMBER','4','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_APE_AYE_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_APE_AYE_YEAR','NUMBER','4','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_APE_PERIOD_NO','NUMBER','2','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_APE_ADMIN_PERIOD_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_SPSU_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_HB_CLAIM_NO','VARCHAR2','25','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PDE_PME_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PDE_PIT_PPR_AYE_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PDE_PIT_PPR_AYE_YEAR','NUMBER','4','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PDE_PIT_PPR_HRV_PPC_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_PDE_PIT_PAYMENT_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_CLEARED_BY_ARRANGE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_EXTRACTED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_EXTRACTED_DATE','DATE',' ','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_BRU_RUN_NO','NUMBER','8','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_RETURNED_BRU_RUN_NO','NUMBER','8','Y',l_t,l_s,l_f);
--PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_RETURNED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_EXPECTED_PAYMENTS','LEXPA_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
