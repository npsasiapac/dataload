--
-- dl_hra_tenant_allowances_tabs.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Tenant Allowances Dataload Tables have the correct columns. 
...
-- ----          ---  ------ ----         ------------
-- 11-FEB-2019   1.0  6.18.0 Rob Heath    Initial Creation.
-- 
-------------------------------------------------------------------------------
--
...
--
--
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_TCY_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_TALT_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_AMOUNT','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_APPROVED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_NEXT_PAYMENT_DUE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_TENANT_ALLOWANCES','LTALL_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
--
