--
-- dl_hra_bde_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Bank Details Dataload Tables have
...
--
--
-- 07-MAR-2011   1.0  5.16.1 PH    Initial Creation.
-- 14-MAR-2011   1.1  5.16.1 PH    Removed the 01 table and remaned 02
--                                 to just dl_hra_bank_deatils. We discard 01
--                                 records.
-- 19-DEC_2016   1.2  6.14    AJ   1)allowed for nullable being the same as current setting
...
--                                 2)Changed to standard production of table and changes
-- 20-DEC-2016   1.2  6.14   AJ    New version for Manitoba
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
-- Data load for Bank Details free format Addresses and telephone number 
--
PR('DL_HRA_BANK_DETAILS','LBDE_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_TYPE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_BRANCH','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_BRANCH_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_ADR1','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_ADR2','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_ADR3','VARCHAR2','36','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_PCODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_PHONE','VARCHAR2','40','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_BANK_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_BANK_NAME','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_AMENDED','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_BDE_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HRA_BANK_DETAILS','LBDE_ADR_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
