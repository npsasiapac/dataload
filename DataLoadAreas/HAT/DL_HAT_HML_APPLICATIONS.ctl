...
infile $gri_datafile
APPEND
into table DL_HAT_HML_APPLICATIONS
...
(
 ...
 LAPP_EXPECTED_HLESS_DATE   DATE "DD-MON-YYYY" NULLIF lapp_expected_hless_date=blanks,
 LIPT_CODE                  CHAR "rtrim(:LIPT_CODE)",    
 LAPP_HRV_HCR_CODE          CHAR "rtrim(:LAPP_HRV_HCR_CODE )",    
 LAPP_HRV_HOR_CODE          CHAR "rtrim(:LAPP_HRV_HOR_CODE)", 
