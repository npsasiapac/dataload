...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Allocations Dataload Bespoke 
-- Tables for Organisation Offers have
-- the correct columns. This script does not drop the
-- data load tables, just adds in any missing columns.
--
-------------------------------------------------------------------------------
--
--
...
-- ----          ---  ------ ----  ------------
-- 28-MAr-2018   1.0  6.16   MJK   Added DL_HAT_ORGANISATION_OFFERS
-- 08-MAY-2018   1.1  6.16   MJK   LOOF_CREATED_DATE and LOOF_ACCEPTED_DATE increased to 30 chars
-- 24-MAY-2018   1.2  6.16   AJ    Changed so table create is bespoke for Organisation Offers
--                                 only name script name change and change control renumbered
--                                 LOOF_REFNO increased from (8) to (10)
--                                 LOOF_CASH_INCENTIVE changed from VARCHAR(10) to NUMBER(8,2)
--                                 Mandatory field check moved from ctl to package and allow nullable
--                                 set to Y(es) apart from the first 3 fields
-- 11-JUN-2018   1.3  6.16   AJ    1) Added the void instances data loader fields LOOF_VIN_ so match
--                                 of void instance created by this data load can be used
--                                 2) LOOF_VIN_REFNO NUMBER(8) added so instance found in validate
--                                 is stored and used for create
-- 18-JUN-2018   1.4  6.16   AJ    removed LOOF_HPS_HPC_CODE as not used       
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_OFFER_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_RESPOND_BY_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_HPS_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_DEC_ALLOWANCE','NUMBER','6,2','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_MAN_CREATED','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_VST_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_TGT_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_APT_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_VGR_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_VPA_CURR_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_HRV_RFV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_HRV_VCL_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_EFFECTIVE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_ALE_APP_LEGACY_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_ALE_RLI_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_TTYP_HRV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_TTY_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_OSG_OST_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_EXPECTED_TCY_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_CASH_INCENTIVE','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_TYPE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_ACCEPTED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_ACCEPTED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HAT_ORGANISATION_OFFERS','LOOF_VIN_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
--
