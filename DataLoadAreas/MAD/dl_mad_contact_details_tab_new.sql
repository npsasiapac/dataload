...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Estates Contact Details Dataload Tables have
...
-- ----          ---  ------ ----  ------------
-- 16-FEB-2011   1.0  6.3.0  VS    Initial Creation.
-- 04-MAR-2015   2.0  6.11   AJ    Amended to Multi Area Data load (MAD)
-- 06-MAR-2015   2.1  6.11   AJ    Amended line 95 and 145 removed single quotes
--                                 from around NULL
-- 01-JUN-2015   2.2  6.11   AJ    show errors added to bottom
-- 04-JUN-2015   2.3  6.11   AJ    renamed sql xxx_tab_new.sql in line with standard 
-- 11-MAY-2016   2.4  6.13   AJ    1) added LCDE_OCO_FORENAME and LCDE_OCO_FORENAME
...
-- 16-JUN-2016   2.5  6.13   AJ    Altered so mandatory fields checks now done by package
--                                 not as part of load process
-- 09-MAR-2017   2.6  6.15   AJ    Added Organisations Contacts extra fields for new create
--                                 into (organisations_cotacts) and new batch question
-- 28-MAR-2017   2.7  6.15   AJ    Added Organisation Contacts lcde_oco_update
...
--
-- 
PR('DL_MAD_CONTACT_DETAILS','LCDE_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_LEGACY_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_CONTACT_VALUE','VARCHAR2','100','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_FRV_CME_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_CONTACT_NAME','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_PRECEDENCE','NUMBER','2','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_FRV_COMM_PREF_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_ALLOW_TEXTS','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_SECONDARY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_FORENAME','VARCHAR2','200','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_SURNAME','VARCHAR2','200','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_FRV_TITLE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_UPDATE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_CREATE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_SIGNATORY_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_FRV_OCR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_FRV_OPL_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_OCO_CREATED','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_CONTACT_DETAILS','LCDE_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
