...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Notepads Dataload Tables have
...
-- ----          ---  ------ ----  ------------
-- 17-OCT-2009   1.0  5.16   VRS   Initial Creation.
-- 05-MAR-2015   2.0  6.11   AJ    Amended Area from HEM (Estates) to MAD (Multi Area)
-- 01-JUN-2015   2.1  6.11   AJ    Added show errors at the bottom
-- 24-MAR-2015   2.2  6.13   AJ    Amended LNOP_TEXT from 2000 to 4000 to match Dbase table
-- 24-MAR-2015   2.3  6.13   AJ    allowed for nullable being the same as current setting
...
-- 11-May-2016   2.4  6.13   AJ    LNOP_TYPE LNOP_LEGACY_REF and LNOP_TEXT nullable set to Y
...
BEGIN
--
PR('DL_MAD_NOTEPADS','LNOP_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_TYPE','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_SECONDARY_REF','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_SECONDARY_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_CURRENT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_HIGHLIGHT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_TEXT','VARCHAR2','4000','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_NTT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_APPLICATION_TYPE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_MAD_NOTEPADS','LNOP_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
--
