--
-- DL_HCS_BUSINESS_ACT_EVENTS_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the CUSTOMER SERVICES Dataload Tables have
...
-- 14-MAR-2016   1.1  6.13.0 PAH   updated lbae_comments field to be varchar2(4000)
-- 18-MAR-2016   1.2  6.13.0 PAH   allowed for nullable being the same as current setting
...
--
-- 
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_ALT_REF','VARCHAR2','25','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_OBJ_LEGACY_REF','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_OBJ_SECONDARY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_LEGACY_TYPE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_TYPE','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_BRO_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_AUN_CODE_RESPONSIBLE','VARCHAR2','20','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_SCO_CODE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_STATUS_DATE','DATE',' ','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_USR_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_BAN_ALT_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_TARGET_DATE','DATE','  ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_LAS_LEA_START_DATE','DATE','  ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACTIONS','LBAN_LAS_START_DATE','DATE','  ','Y',l_t,l_s,l_f);
--
--
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_BAN_ALT_REF','VARCHAR2','25','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_SEQUENCE','NUMBER','6','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_TYPE','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_AET_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_BAA_BAP_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_BAA_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_SCO_CODE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_STATUS_DATE','DATE',' ','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_INSERTED_DATETIME','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_USR_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_ACTUAL_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_TARGET_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_EXPIRY_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_COMMENTS','VARCHAR2','4000','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_PREV_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_LINKED_EVENT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_LINKED_BAN_REF','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_EVENTS','LBAE_LINKED_EVENT_SEQUENCE','NUMBER','6','Y',l_t,l_s,l_f);
--
