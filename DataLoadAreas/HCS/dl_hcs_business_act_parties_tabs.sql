--
-- dl_hcs_business_act_parties_tabs.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Business Action Parties Dataload Tables have the correct columns. 
...
--
--
-- BUSINESS_ACT_PARTIES
--
--
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_BAN_REFERENCE','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_MAIN_PARTY_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_HRV_BAC_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_OBJECT_TYPE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_OBJECT_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HCS_BUSINESS_ACT_PARTIES','LBPA_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
--
