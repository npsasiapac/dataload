--
-- dl_hcs_people_group_tabs.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the People Group Dataload Tables have the correct columns. 
-- This script does not drop the dataload tables, just adds in missing columns.
--
-------------------------------------------------------------------------------
--
--
...
-- ----          ---  ------ ----         ------------
-- 24-JAN-2019   1.0  6.18.0 Rob Heath    Initial Creation.
-- 
-------------------------------------------------------------------------------
--
...
--
--
PR('DL_HCS_PEOPLE_GROUPS','LPEG_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_DESCRIPTION','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_PGT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUPS','LPEG_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
--
--
-- PEOPLE_GROUP_MEMBERS
--
--
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_PEG_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_PAR_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_KEY_MEMBER_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_MEMBERS','LPGE_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
--
--
-- PEOPLE_GROUP_ROLES
--
--
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_PGE_PEG_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_PGE_PAR_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_GRO_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_PEOPLE_GROUP_ROLES','LPGO_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
--
--
