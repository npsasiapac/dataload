--
-- DL_HCS_CONTACTS_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the CUSTOMER SERVICES CONTACTS Dataload Tables have
-- the correct columns. This script does not drop the data load tables
-- just adds in any missing columns.
--
-------------------------------------------------------------------------------
--
...
-- ** bespoke for HCS Contacts **
--
-- 18-SEP-2018   1.3  6.16.1 MOK   Initial Version for bespoke HCS Contacts 
-- 10-OCT-2018   1.4  6.16.1 AJ    Bespoke Change control added
-- 26-MAR-2019   1.5  6.18   AJ    Added field lscn_reference to store scn_refno from the
--                                 subj_cont_bus_reasons table if created
--
-- ***********************************************************************
--
...
BEGIN
--
PR('DL_HCS_CONTACTS','LCCT_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_OBJ_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SECONDARY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SECONDARY_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_LEGACY_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_RECEIVED_DATE','DATE',' ','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_CCM_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_CNY_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SUB_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SUB_SEC_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SUB_SEC_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SUBJECT_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SCN_BRO_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SCN_BRC_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SCN_TARGET_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_DURATION','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_AUN_CODE_RESPONSIBLE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_SCO_CODE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_STATUS_DATE','DATE',' ','N',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_USR_JRO_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_USR_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_CORRESPOND_REFERENCE','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_ANSWERED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_ANO_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_OUTCOME_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_BAN_ALT_REF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LCCT_REFERENCE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HCS_CONTACTS','LSCN_REFERENCE','VARCHAR2','10','Y',l_t,l_s,l_f);
--
