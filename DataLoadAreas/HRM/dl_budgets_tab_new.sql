...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the budgets Dataload Tables have
...
-- ----          ---  ------   ----  ------------
-- 26-JUL-2014   1.0  5.5.0    IR    Create dl_hrm_budgets table
-- 21-AUG-2015   1.1  6.12.0   DLB   Change public grant for HOU_FULL.
-- 21-AUG-2015   1.2  6.12.0   AJ    Added grant for FSC_FULL as per DLB's advice.
-- 01-MAR-2016   1.3  6.13     AJ    1)Altered to match standard xx_tab_new.sql
...
BEGIN
--
PR('DL_HRM_BUDGETS','LBUD_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BHE_CODE','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BHE_DESCRIPTION','VARCHAR2','40','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BHE_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BHE_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BCA_YEAR','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TYPE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_AMOUNT','NUMBER','12,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_ALLOW_NEGATIVE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_REPEAT_WARNING_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_WARNING_ISSUED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BUD_BHE_CODE','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_BPCA_BPR_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_WARNING_PERCENT','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_COMMENTS','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_COMMITTED','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_ACCRUED','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_INVOICED','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_EXPENDED','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_CREDITED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TAX_COMMITTED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TAX_ACCRUED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TAX_INVOICED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TAX_EXPENDED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_TAX_CREDITED','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HRM_BUDGETS','LBUD_ARC_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
--
--
