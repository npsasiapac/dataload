...
-- 01-MAR-2016   2.2  6.13   AJ    The following changes were added to bring
--                                 up to date
--                                 1)Include grants to FSC.
--                                 2)Bespoke version for Budgets DL
--
--
--
set lines 200
...
where u1.object_type =    'PACKAGE'
  and u1.object_name like 'S_DL_HRM_BUDGET%'
...
where u1.object_type =    'TABLE'
  and u1.object_name like 'DL_HRM_BUDGET%'
