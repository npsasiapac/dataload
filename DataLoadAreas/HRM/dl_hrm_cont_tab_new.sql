...
-- ----          ---  ------ ----  ------------
-- 27-JUL-2012   1.0  6.5.0  PH    Initial Creation. Ottawa Bespoke
-- 14-OCT-2014   2.0               Contractor Site Trades and Pricing Policy
--                                 for Con Sites added
-- 01-FEB-2016   3.0  6.13   AJ    Added mlang fields for contractors and contractor sites
-- 22-MAR-2016   4.0  6.13   MK    Allowed for nullable being the same as current setting
...
-- 22-MAR-2016   4.1  6.13   AJ    amended pre and post inspection limit to Num (9,2)
--                                 to match Dbase and data contractors load guide
-- 08-JUL-2016   4.2  6.13   AJ    Added dl_hrm_con_site_job_roles table new data load
--                                 added to HRM Contractors data load
-- 11-JUL-2016   4.3  6.13   AJ    Amended DL_HRM_CONTRACTORS field LCON_JRB_PK_CODE1 from
--                                 4000 to 15 to match con site code max length
-- 
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HRM_CONTRACTORS','LCON_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_NAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_HRV_CTY_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_TAX_REG_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_EQUAL_OP_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_VATNO','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_BUSINESS_NO','VARCHAR2','18','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_BN_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_BN_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_TAX_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_TAX_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_HRM_RCPT_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_HRM_RCPT_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_HPM_RCPT_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_HPM_RCPT_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_FK_VENDOR_ID','NUMBER','20','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_NAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MAX_WO_NO','NUMBER','5','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MAX_WOS_TOTAL_VALUE','NUMBER','14,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MAX_WO_VALUE','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_HS_CERT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_QUALITY_ASSURED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_ASBESTOS_APPROVED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_HPM_AUTHORISED_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_FCA_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_PRE_INSPECT_LIMIT','NUMBER','9,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_POST_INSPECT_LIMIT','NUMBER','9,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_YEAR_REGD','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MIN_WO_VALUE','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MAX_JOB_EST_COST_VAR','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_MAX_JOB_EST_TAX_VAR','NUMBER','8,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_NO_CURRENT_WOS','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_VALUE_CURRENT_WOS','NUMBER','14,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_FK_VENDOR_SITE_ID','NUMBER','20','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_SPR_PRINTER_NAME','VARCHAR2','80','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_COS_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_PAYMENT_INTERVAL','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_JRB_JRO_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_JRB_OBJ_NAME','VARCHAR2','255','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_JRB_READ_WRITE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_JRB_PK_CODE1','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_PHONE','VARCHAR2','100','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_APPT_TYPE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_TP_APPT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_AUTO_INV_MIN_DELAY','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_AUTO_INV_DELAY_DAYS','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_AUTO_REC_DELAY_DAYS','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_AUTO_JOB_COMP_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_AUTO_JOB_COMP_DELAY','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_CODE_MLANG','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_NAME_MLANG','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_CODE_MLANG','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CONTRACTORS','LCON_COS_NAME_MLANG','VARCHAR2','50','Y',l_t,l_s,l_f);
--
PR('DL_HRM_PP_CON_SITES','LPPC_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_PPP_WPR_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_PPP_PPG_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_COS_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_FCA_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_AGREED_PERCENTAGE','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_WORKS_ORDERS_COUNT','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HRM_PP_CON_SITES','LPPC_MIN_WO_VALUE','NUMBER','8,2','Y',l_t,l_s,l_f);
--
PR('DL_HRM_CON_SITE_TRADES','LCSR_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_COS_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_HRV_TRD_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_LABOUR_DAY_RATE','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_LABOUR_OVERTIME','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_TRADE_DAY_RATE','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_TRADE_OVERTIME','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_MILEAGE_RATE','NUMBER','5,2','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_TRADES','LCSR_CALL_OUT_CHARGE','NUMBER','5,2','Y',l_t,l_s,l_f);
--
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_JRB_JRO_CODE','VARCHAR2','15','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_JRB_READ_WRITE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HRM_CON_SITE_JOB_ROLES','LCSJ_JRB_PK_CODE1','VARCHAR2','4000','Y',l_t,l_s,l_f);
--
