-- Script Name = hdl_cont_dlas_in.sql
---------------------------------------------------------------------- 
--
...
--   1.0   6.5.0   PH     27/07/12 Bespoke for Ottawa
--   1.1   6.13    AJ     08/07/16 Added new data load area for Manitoba
--                                 of HRM_CON_SITE_JOB_ROLES
--
------------------------------------------------------------------------------- 
--
--
...
BEGIN
--
ins_dla('HRM','CONTRACTORS','Y','','','');
--
ins_dla('HRM','PP_CON_SITES','Y','','','');
--
ins_dla('HRM','CON_SITE_TRADES','Y','','','');
--
ins_dla('HRM','CON_SITE_JOB_ROLES','Y','','','');
--
END;
/
