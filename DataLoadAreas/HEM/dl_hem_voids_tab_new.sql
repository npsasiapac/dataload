...
-- ----          ---  ------ ----  ------------
-- 18-NOV-2015   1.0  6.13.0 MJK   Create Void Events data load only
-- 21-MAR-2016   1.1  6.13   AJ    Allowed for nullable being the same as current setting
...
-- 06-JUN-2016   1.1  6.13   AJ    Not null indicators removed from void instances fields
--                                 other than the normal top three as check should be in
--                                 package
-- 08-AUG-2016   1.2  6.13   AJ    Amended LVIN_PRO_PROPREF to allow nullable as check for
--                                 supplied data done in package
-- 06-FEB-2017   1.3  6.14   AJ    Create Void Status History data load for Queensland CR461 
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HEM_VOID_INSTANCES','LVIN_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_STATUS_START','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_DEC_ALLOWANCE','NUMBER','6,2','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_MAN_CREATED','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_VST_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_TGT_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_APT_CODE','VARCHAR2','8','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_VGR_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_VPA_CURR_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_HRV_RFV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_HRV_VCL_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_EFFECTIVE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_UPD_VIN_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_INSTANCES','LVIN_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
--
PR('DL_HEM_VOID_EVENTS','LVEV_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_VIN_HPS_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_VIN_HPS_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_VIN_HPS_HPC_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_INT_SEQNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_ORDER_SEQNO','NUMBER','6','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_EVT_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_EVENT_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_TARGET_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_CALC_EXT','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_DEV_VPA_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_DEV_SEQNO','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_SYS_UPDATED','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_SOURCE_TYPE','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_OFF_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_VIN_EFFECTIVE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_UPD_VIN_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_EVENTS','LVEV_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
--
PR('DL_HEM_VOID_STATUS_HIST','LVSH_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_VIN_HPS_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_VIN_HPS_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_VIN_HPS_HPC_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_VIN_VST_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_VIN_STATUS_STARTED','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_VOID_STATUS_HIST','LVSH_UPD_VIN_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
--
