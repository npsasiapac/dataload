...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Reference Domains Dataload Tables have
...
-- ----          ---   ------  ----  ------------
-- 28-MAR-2018   1.0   6.16.1  AJ    Initial Creation based on HAT tab new sql (v4.6)
--                                   for OHMS migration
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DOMAIN','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_NAME','VARCHAR2','40','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_CURRENT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DEFAULT_OPT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_LENGTH','NUMBER','2','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_USAGE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_CREATION_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_PRODUCT_IND','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_DOMAIN_MLANG','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_DOMAINS','LFRD_NAME_MLANG','VARCHAR2','40','Y',l_t,l_s,l_f);
--
--
PR('DL_HEM_FIRST_REF_VALUES','LFRV_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_FRD_DOMAIN','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_NAME','VARCHAR2','40','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_CURRENT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_USAGE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_CREATION_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_DEFAULT_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_SEQUENCE','NUMBER','6','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_TEXT','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_CODE_MLANG','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_FIRST_REF_VALUES','LFRV_NAME_MLANG','VARCHAR2','40','Y',l_t,l_s,l_f);
--
