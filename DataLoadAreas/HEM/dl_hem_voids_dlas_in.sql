-- Script Name = dl_hem_voids_dlas_in.sql
---------------------------------------------------------------------- 
--
...
--
--   Ver		DB 		Who    Date          Reason
--   1.0		6.13.0  MJK    18-NOV-2015   Just for Void Events Data load
--   1.1		6.13    MOK    24-MAY_2016   Added Void Instances
--   1.2		6.14    AJ     06-FEB-2017   Added Void Status History
--
------------------------------------------------------------------------------- 
--
--
...
BEGIN
--
ins_dla('HEM','VOID_INSTANCES','Y','','','');
ins_dla('HEM','VOID_STATUS_HIST','Y','','','');
ins_dla('HEM','VOID_EVENTS','Y','','','');
--
END;
/
