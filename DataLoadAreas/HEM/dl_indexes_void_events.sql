...
-- 21-MAR-2016   1.4  6.13   AJ    Bespoke version for void_events only
-- 30-JAN-2017   1.5  6.13   AJ    Bespoke now for void_instances and events
--                                 actual change done on 06-JUN-2016 but
--                                 control and version number updated today
--                                 no change to actual working bit of script
-- 08-FEB-2017   1.6  6.14/5 AJ    Amended added extra blank lines at bottom
--
-------------------------------------------------------------------------------
--
--
...
AND    t1.table_name  like 'DL_HEM_VOID%'
...
AND    i1.table_name   like 'DL_HEM_VOID%'
