--
-- dl_hem_object_admin_units_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Object Admin Units Security (Estates) Dataload Tables have
...
-- ----          ---  ------ ----  ------------
-- 24 SEP 2013   1.0  6.9.0  AJ    Initial Creation.
--
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_REC_TYPE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_OBJ_REF','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_OBJECT_ADMIN_UNITS','LOAU_DEL_OAU_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_USR_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_OBJ_NAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_ACCESS_LEVEL','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_USER_OBJ_ADMIN_UNITS','LUOA_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
--
