...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Person Also Known As Dataload Tables have
...
-- ----          ---   ------  ----  ------------
-- 11-JAN-2019   1.0   6.18    JT    Initial Creation for SAHT
--                                   based on dl_hem_reference_domains_tab_new
--
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
--
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_PER_ALT_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_PER_FORENAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_PER_SURNAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_FRV_AKAR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_FORENAME','VARCHAR2','250','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_SURNAME','VARCHAR2','250','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_ALSO_KNOWN_AS','LPAKA_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
--
