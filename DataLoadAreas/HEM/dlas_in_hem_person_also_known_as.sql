-- Script Name = dlas_in_hem_person_also_known_as.sql
---------------------------------------------------------------------- 
--
-- This script is the dlas script for Person Also Known As data load only
--
-- Script to insert Housing DL Load Area records
--
--   Ver	DB 		 Who    Date         Reason
--   1.0    6.18     JT     07-JAN-2019  Initial Creation for SAHT
--
------------------------------------------------------------------------------- 
--
--
...
BEGIN
--
ins_dla('HEM','PERSON_ALSO_KNOWN_AS','Y','','','');
--
END;
/
