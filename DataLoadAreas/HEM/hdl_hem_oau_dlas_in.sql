--
--
-- Script Name = hdl_hem_oau_dlas_in.sql
--
---------------------------------------------------------------------- 
--
-- This script is for Object Admin Unit Security data load only
--
-- Script to insert Housing DL Load Area records
--
--   Ver   DB Ver  Who    Date        Reason
--   1.0   6.9.0   AJ     25/10/2013  initial creation
--
------------------------------------------------------------------------------- 
--
--
...
BEGIN
--
ins_dla('HEM','OBJECT_ADMIN_UNITS','Y','','','');
--
ins_dla('HEM','USER_OBJ_ADMIN_UNITS','Y','','','');
--
END;
/
