--
-- dl_hem_person_name_history_tab_new.sql
--
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Estates Person Name History Dataload Tables have
...
-- ----          ---  ------ ----  ------------
-- 17-FEB-2011   1.0  6.3.0  VS    Initial Creation.
-- 17-FEB-2013   1.1  6.6.0  PJD   Only the 3 'Batch related' columns should be
--                                 mandatory. Alt Ref, Start Date, End Date and
--                                 fph_code fields changed to non-mandatory.
--                                 Additional validation will need to be added
--                                 to the pkb.
-- 11-DEC-2018   1.2  6.18   PJD   Name Field Sizes increased from 20 to 50 chars
--                                 or 50 to 100 chars
-------------------------------------------------------------------------------
--
...
--
-- 
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_PAR_TYPE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_PAR_PER_ALT_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_FRV_FPH_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_USERNAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_SURNAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_FORENAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_INITIALS','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_TITLE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_OTHER_NAMES','VARCHAR2','100','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_SURNAME_PREFIX','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_SURNAME_MLANG','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_FORENAME_MLANG','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_INITIALS_MLANG','VARCHAR2','5','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_NAME_HISTORY','LPNH_OTHER_NAMES_MLANG','VARCHAR2','100','Y',l_t,l_s,l_f);
--
--
