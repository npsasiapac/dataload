...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Landlord Banks dataload table has
...
-- ----          ---  ------ ----  ------------
-- 15-JUL-2016   1.0  6.13   MB    Copy of Estates tabcr script for PLB bespoke for Link
-- 21-JUL-2016   1.1  6.13   AJ    script name amended to match current convention and
--                                 updated to include re-runable fix where current and
--                                 amended fields are both nullable
-- 26-JUL-2016   1.2  6.13   AJ    Added further fields for more detail
--                                 for bank_details and to help delete
--                                 process
-- 29-JUL-2016   1.3  6.13   AJ    Amended delete the 3 indicator fields added "_IND"
--                                 to make them stand out more
-- 01-AUG-2016   1.3  6.13   AJ    renamed LPLB_DEL_PLB_REFNO to LPLB_DEL_PLD_REFNO
--                                 as property landlords reference and added LPLB_END_DATE
--
-------------------------------------------------------------------------------
--
...
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_PLD_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_PAR_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_ALT_PAR_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BAD_ACCOUNT_NO','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BAD_ACCOUNT_NAME','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BAD_SORT_CODE','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BAD_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BANK_NAME','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BRANCH_NAME','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BTY_CODE','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BANK_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BRANCH_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BANK_NAME_MLANG','VARCHAR2','35','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_BDE_BRANCH_NAME_MLANG','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_BDE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_BAD_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_PBA_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_BDE_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_BAD_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_PAR_REFNO','NUMBER','10','Y',l_t,l_s,l_f); 
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_DEL_PLD_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_PLD_PRO_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PROP_LANDLORD_BANKS','LPLB_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
--
