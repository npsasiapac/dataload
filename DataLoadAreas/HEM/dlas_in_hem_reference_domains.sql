-- Script Name = dlas_in_hem_reference_domains.sql
---------------------------------------------------------------------- 
--
-- This script is the dlas script for Reference Domains data load only
--
-- Script to insert Housing DL Load Area records
--
--   Ver	DB 		 Who    Date         Reason
--   1.0    6.16.1   AJ     28-MAR-2018  Initial Created for OHMS migration
--
------------------------------------------------------------------------------- 
--
--
...
BEGIN
--
ins_dla('HEM','FIRST_REF_DOMAINS','Y','','','');
ins_dla('HEM','FIRST_REF_VALUES','Y','','','');
--
END;
/
