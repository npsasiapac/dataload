...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Estates Organisations Tables have
...
-- ----          ---   ------  ----   ------------
-- 02-MAR-2016   1.0   6.13    AJ    Initial Creation based on dl_hem_tab_new.sql (v3.4).
-- 08-FEB-2016   1.1   6.13    AJ    1) allowed for nullable being the same as current setting
...
--                                   2) Added table DL_HEM_ORG_HIERARCHY
-- 22-DEC-2016   1.2   6.14    AJ    1) Added table DL_HEM_ORG_ADMIN_UNITS
--                                   2) Slightly amended nullable changes to fix known issues
-- 07-MAR-2017   1.3   6.14    AJ    Added LORAU_PAR_ORG_CURRENT_IND and amended corrected
--                                   PAR_ORG_SHORT_CODE to PAR_ORG_SORT_CODE
-- 05-APR-2017   1.4   6.14    AJ    Removed PAR_ORG_CURRENT_IND and PAR_ORG_SORT_CODE
--                                   and added LORAU_OLD_COMMENTS
--
-------------------------------------------------------------------------------
--
...
PR('DL_HEM_ORG_HIERARCHY','LORHI_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_NAME','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_SHORT_NAME','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_FRV_OTY_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_NAME_C','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_SHORT_NAME_C','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_ORG_FRV_OTY_CODE_C','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_PAR_REFNO_C','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_FRV_ORT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_HIERARCHY','LORHI_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_PAR_ORG_NAME','VARCHAR2','60','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_PAR_ORG_SHORT_NAME','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_PAR_ORG_FRV_OTY_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_FRV_OAR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_NEW_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_C_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_OLD_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_OLD_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_OLD_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_OLD_FRV_OAR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_ORG_ADMIN_UNITS','LORAU_OLD_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
--
