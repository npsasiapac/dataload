...
-- 21-MAR-2016   3.2  6.13    AJ    Added FSC and made bespoke for void Eevents
--
--
set lines 200
...
where u1.object_type =    'PACKAGE'
  and u1.object_name like 'S_DL_HEM_VOID_EVENT%'
...
where u1.object_type =    'TABLE'
  and u1.object_name like 'DL_HEM_VOID_EVENT%'
