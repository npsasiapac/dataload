...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Person Attributes Dataload Tables have
...
-- ----          ---  ------ ----  ------------
-- 07-MAR-2011   1.0  6.3.0  VS    Initial Creation.
-- 
-- 26-NOV-2015   2.0  6.12   VS    Checked/Updated for v6.12
-- 06-JUN-2016   3.4  6.13   AJ    allowed for nullable being the same as current setting
...
--
-- 
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_PAR_TYPE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_CLASS_CODE','VARCHAR2','8','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_PAR_PER_ALT_REF','VARCHAR2','20','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_PEAT_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_PAAV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_YES_NO_VALUE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_DATE_VALUE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_NUMERIC_VALUE','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_TEXT_VALUE','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATTRIBUTES','LPEPA_REFNO','NUMBER','10','N',l_t,l_s,l_f);
--
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_PAR_TYPE','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_PAR_PER_ALT_REF','VARCHAR2','20','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_PEAT_CODE','VARCHAR2','10','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_ORIGINAL_CREATED_BY','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_ORIGINAL_CREATED_DATE','DATE',' ','N',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_PAAV_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_DATE_VALUE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_NUMERIC_VALUE','NUMBER','10,2','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_TEXT_VALUE','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HEM_PERSON_PEO_ATT_HISTS','LPPAH_YES_NO_VALUE','VARCHAR2','1','Y',l_t,l_s,l_f);
--
--
