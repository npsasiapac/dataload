...
IS
 ...
 PROCEDURE set_record_status_flag(
  ...
  PROCEDURE run_process(
    p_sys_var1 IN VARCHAR2 DEFAULT NULL, -- p_batch_id IN VARCHAR2
    p_sys_var2 IN VARCHAR2 DEFAULT NULL, -- p_app_area      IN VARCHAR2
    p_sys_var3 IN VARCHAR2 DEFAULT NULL, -- p_dataload_area IN VARCHAR2
    p_sys_var4 IN VARCHAR2 DEFAULT NULL, -- p_process   IN VARCHAR2
  ...
  BEGIN  -- module_function
    ...
    fsc_utils.debug_message( 's_dl_utils.run_process',3 );
    ...
    IF l_process != 'LOAD'
    THEN
      EXECUTE IMMEDIATE 'BEGIN s_dl_'||l_app_area||'_'||l_package_name||'.DATALOAD_'||l_process||'( '''||L_BATCH_ID||'''
 , '||
  ...
  BEGIN
    ...
    fsc_utils.debug_message( 's_dl_utils.queue_process',3 );
