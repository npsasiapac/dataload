-- Script Name = psl_hpl_schemes_dlas.sql
---------------------------------------------------------------------- 
--
-- This script replaces all other dlas scripts
--
-- Script to insert Housing DL Load Area records for bespoke psl_schemes
--
--
--   Ver   DB Ver  Who    Date         Reason
--   1.0   6.15.0  MJK    01-MAY-2013  Initial Creation.
--   1.1   6.15.0  AJ     23-MAY-2013  Altered so based on generic v3.18(Apr2017)
--                                     rather than just a single row insert as
--                                     does a check and allows for changes
------------------------------------------------------------------------------- 
--
--
