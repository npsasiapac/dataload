...
--
-- 21-AUG-2015   1.1  6.10.0  AJ    Removed the field LPSLR_END_EXISTING
--                                  from DL_HPL_PSL_LEASE_RENTS as not used
-- 23-FEB-2016   1.2  6.13    AJ    1) Allowed for nullable being the same as current setting
...
--                                  2) Added LPSL_RENT_COMMENTS to DL_HPL_PSL_LEASES
--                                  3) Added LPSLR_COMMENTS to DL_HPL_PSL_LEASE_RENTS
-- 01-MAR-2016   1.3  6.13    AJ    1) Amended LPSLR_PSL_REF_TYPE from (1) to (10)
-- 21-APR-2016   1.4  6.13    AJ    Amended both DL_SEQNO fields as NUMBER(10) left blank by mistake
-- 24-MAY-2017   1.5  6.14/5  AJ    Amended psl_leases table removed not nullable fields as check needs
--                                  to be done in package for mandatory items
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_HPL_PSL_LEASES','LPSL_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_LEGACY_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PRO_PROPREF','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_LEASE_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_LEASE_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PSY_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_STATUS_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_SCL_PSLS_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_RENT_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_RENT_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_EXTENSION_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PROPOSED_HANDBACK_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_EXT_NOTICE_SERVED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_HBACK_NOT_SERVE_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_ACTUAL_HANDBACK_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PSLR_ANNUAL_RENT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_SCL_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_SCL_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PSLR_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PSLR_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_PSLR_REVIEW_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_LLORD_PAID_IN_ADVANCE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASES','LPSL_RENT_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
--
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_PSL_REF_TYPE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_PSL_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_ANNUAL_RENT','NUMBER','11,2','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_END_EXISTING','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_REVIEW_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HPL_PSL_LEASE_RENTS','LPSLR_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
--
