...
-- 23-MAY-2016   1.1  6.13   AJ    allowed for nullable being the same as current setting
...
BEGIN
--
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_BHE_CODE','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_BCA_YEAR','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_HPM_MAN_AREA_BUDGETS','LMAB_DEL_BUD_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
--
--
