-- Script Name = dl_cus_dl_batches.sql
---------------------------------------------------------------------- 
--
...
--   1.0   6.16.1  PML    01/06/18 Standard Dataload Install Script
--   1.1   6.16.1  PML    13/06/18 Changed question
-------------------------------------------------------------------
--
--
...
--
ins_dla('CUS','DATALOAD_BATCHES','Y','Continue after Load?','Continue on Fail?','');
--
END;
/
