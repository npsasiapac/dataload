...
-- ----          ---  ------ ----  ------------
-- 01 JUNE 2018  1.0  6.16.1 PL    Initial Creation.
--
--
-------------------------------------------------------------------------------
--
...
BEGIN
--
PR('DL_CUS_DATALOAD_BATCHES','LDL_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_DL_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);

PR('DL_CUS_DATALOAD_BATCHES','LDL_BATCH_SEQNO','NUMBER','8','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_PRODUCT_AREA','VARCHAR2','3','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_DATALOAD_AREA','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_QUESTION_ANSWER1','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_QUESTION_ANSWER2','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_LOAD_END','DATE','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_VALIDATE_START','DATE','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_VALIDATE_END','DATE','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_CREATE_START','DATE','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_CREATE_END','DATE','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_REFNO','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_CUS_DATALOAD_BATCHES','LDL_TOTAL_RECORDS','NUMBER','10','Y',l_t,l_s,l_f);
