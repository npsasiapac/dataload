...
--------------------------------- Comment -------------------------------------
--
-- Script to ensure the Support Services data load Tables have
...
--  1.2     6.18      AJ   17-FEB-2019  Amended
--  1.3     6.18      AJ   25-MAR-2019  1)All data fields bar first 3 set to allow null
--                                      2)Field LREF_DEN_TO_SUPR_CODE should be 240
--
-------------------------------------------------------------------------------
--
...
--
-- Referrals
PR('DL_HSS_REFERRALS','LREF_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_ALTERNATE_REF','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_TYPE','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CLNT_PAR_PER_FORENAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CLNT_PAR_PER_SURNAME','VARCHAR2','50','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_PAR_PER_DATE_OF_BIRTH','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_PAR_PER_ALT_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_SCO_CODE','VARCHAR2','3','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_STATUS_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_RECEIVED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CSVC_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_TO_SUPR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_DEN_TO_SUPR_CODE','VARCHAR2','240','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f); 
PR('DL_HSS_REFERRALS','LREF_REFERENCE','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_REUSABLE_REFNO','NUMBER','20','Y',l_t,l_s,l_f);
PR('DL_HSS_REFERRALS','LREF_CLIENT_PAR_REFNO','NUMBER','8','Y',l_t,l_s,l_f);
--
-- Generic Question Responses not currently required
--PR('DL_HSS_GENRIC_QTN_RESPONSES','LCQRE_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
--PR('DL_HSS_GENRIC_QTN_RESPONSES','LCQRE_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
--PR('DL_HSS_GENRIC_QTN_RESPONSES','LCQRE_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
--
