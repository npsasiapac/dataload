...
-- 1.0                   IR  25-Sep-09    Initial Creation
-- 2.0        6.14       AJ  16-MAR-2016  Changed to current loop method of creation 
--
-- *********************************************************************
--
--
...
--
ins_dla('LTL','LAND_TITLES','Y','','','');
--
ins_dla('LTL','LAND_TITLE_RELEASES','Y','','','');
--
ins_dla('LTL','LAND_TITLE_ASSIGN','Y','','','');
--
--
END;
/
