...
--------------------------------- Comment -------------------------------------
--
-- Land Titles Dataload Table Creation Script
--
-- Initial Creation I Rowell 29-10-07
--
-------------------------------------------------------------------------------
--
--  CHANGE CONTROL
--  VERSION  DB VER  WHO   WHEN        WHY
--                   IR    29-Oct-07   Initial Creation
--                   IR    13-Dec-07   Added lltr_section_number
--                                     and llta_section_number
--                   IR    19-Mar-08   Changed lltl_par_refno to varchar2(20)
--  1.0      6.13    MJK   12-Nov-15   Changed to use par_per_alt_ref and par_org_frv_oty_code
--  1.1      6.13    MJK   18-Nov-15   Grants to ALL to PUBLIC changed to HOU_FULL
--  1.2      6.13    AJ    29-JAN-16   Grants to ALL to FSC added in line with other data loads
--  1.3      6.14    AJ    16-MAR-16   1) changed from old style to new style sql
--                                     2) lltl_lot_number amended from (4) to (6) at v6.14 and included
--                                     in a back patch at v6.13 for Queensland
--                                     3) allowed for nullable being the same as current setting
...
--  1.4      6.14    AJ    18-MAR-16   1) added DL_LTL_LAND_TITLE_ASSIGN table to sql
--
-------------------------------------------------------------------------------
--
...
PR('DL_LTL_LAND_TITLES','LLTL_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_PLAN_NUMBER','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_LOT_NUMBER','VARCHAR2','6','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_LTT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_PAR_PER_ALT_REF','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_PAR_ORG_SHORT_NAME','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_PAR_ORG_FRV_OTY_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_AREA_MEASUREMENT','NUMBER','10,1','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_DATE_TYPE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_AFFECT_EASE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_APPURT_EASE_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_RESIDUAL_IND','VARCHAR2','1','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_VOLUME_NUMBER','NUMBER','5','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_SECTION_NUMBER','VARCHAR2','4','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_CONSOLIDATION_NUMBER','VARCHAR2','9','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_FOLIO_NUMBER','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_BOOK_NUMBER','NUMBER','5','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_BOOK_SEQUENCE_NUMBER','NUMBER','3','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_CLOSED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_HRV_FLTC_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_CLOSED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_NUM_PROPERTIES','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_NUM_PROPERTIES_OWNED','NUMBER','4','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_LLTL_PLAN_NUMBER','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_LLTL_LOT_NUMBER','VARCHAR2','6','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_LLTL_LTT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLES','LLTL_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
--
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_LLTL_PLAN_NUMBER','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_LLTL_LOT_NUMBER','VARCHAR2','6','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_LLTL_LTT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_RELEASED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_RELEASED_TO','VARCHAR2','40','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_HRV_FTRR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_MATTER_NUMBER','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_RETURNED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_RELEASES','LLTR_SECTION_NUMBER','VARCHAR2','4','Y',l_t,l_s,l_f);
--
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_DLB_BATCH_ID','VARCHAR2','30','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_DL_SEQNO','NUMBER','10','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_DL_LOAD_STATUS','VARCHAR2','1','N',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_LLTL_PLAN_NUMBER','NUMBER','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_LLTL_LOT_NUMBER','VARCHAR2','6','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_LLTL_LTT_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_START_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_PRO_REFNO','VARCHAR2','25','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_AUN_CODE','VARCHAR2','20','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_END_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_HRV_FACR_CODE','VARCHAR2','10','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_COMMENTS','VARCHAR2','2000','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_CREATED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_CREATED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_MODIFIED_BY','VARCHAR2','30','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_MODIFIED_DATE','DATE',' ','Y',l_t,l_s,l_f);
PR('DL_LTL_LAND_TITLE_ASSIGN','LLTA_SECTION_NUMBER','VARCHAR2','4','Y',l_t,l_s,l_f);
--
