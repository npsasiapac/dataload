...
-- 31-JUL-2015   4.0  6.11   AJ    Grant on PUBLIC replaced with HOU_FULL
-- 25-AUG-2015   5.0  6.12   DLB   Include grants to FSC.
-- 18-MAR-2016   6.0  6.14   AJ    BESPOKE FOR Land Titles Data Load 
--                                 all start S_DL_LTL_LAND... or DL_LTL_LAND... 
--
set lines 200
...
where u1.object_type =    'PACKAGE'
  and u1.object_name like 'S_DL_LTL_LAND%'
...
where u1.object_type =    'TABLE'
  and u1.object_name like 'DL_LTL_LAND%'
